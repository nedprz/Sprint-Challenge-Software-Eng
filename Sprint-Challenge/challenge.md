...
- What, in your opinion, is an important part of code reviews? That is, what is
  ...
  An import part of code review is making sure that functions and modules have a consistent style and format so that future users of the code aren't confused by the code. Also you wouldn't want someone to misuse your code. So for example if you have a function that takes a weight then a height, you wouldnt want to have another function that takes a height and then a weight. The lack of consistency would make it hard for future users to understand the code without constantly going through the documentation.
...
- We have an awful lot of computers here, and it gets pretty confusing with
  ...
  Using a program like docker to use containers can help because it creates a simple linux instance in which to run your python code. This simple linux instance reduces the number of annoyances and compatability issues you will have with hardware, drivers, operating systems etc. A user knows that if they run a program in docker on their machine, it will run the same way on the machine of the person to whom they are sending the code.
